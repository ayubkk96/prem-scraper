    ...
    <div class="home">
        ...
        <div class="wrapper">
            ...
            <div class="one" style="text-align: center">
                ...
                <p id="demo" style="background-color: black; color: white">{{countdownToNextGame(yearmmdd, kickofftime )}}</p>
        ...
        methods: {
            sendData() {
                axios.get('http://localhost:3000/teams').then(result => {
                    ...
                    this.nextgame = result.data.data[0].next_game;
                    this.teamname = result.data.data[0].team_name;
                    this.stadium = result.data.data[0].stadium;
                    this.teamurl = result.data.data[0].team_url;
                    this.matchesplayed = result.data.data[0].matches_played;
                    this.wins = result.data.data[0].wins;
                    this.losses = result.data.data[0].losses;
                    this.goals = result.data.data[0].goals;
                    this.goalsconceded = result.data.data[0].goals_conceded;
                    this.cleansheets = result.data.data[0].clean_sheets;
                    this.topscorer = result.data.data[0].top_scorer;
                    this.topscorernumber = result.data.data[0].top_scorer_number;
                    this.topassister = result.data.data[0].top_assister;
                    this.topassisternumber = result.data.data[0].top_assister_number;
                    this.alltimeappearances = result.data.data[0].all_time_appearances;
                    this.alltimeappearancesnumber = result.data.data[0].all_time_appearances_number;
                    this.alltimescorer = result.data.data[0].all_time_scorer;
                    this.alltimescorernumber = result.data.data[0].all_time_scorer_number;
                    this.alltimeassister = result.data.data[0].all_time_assister;
                    this.alltimeassisternumber = result.data.data[0].all_time_assister_number;
                    this.topscorerimagelink = result.data.data[0].image_scorer;
                    this.topassisterimagelink = result.data.data[0].image_assister;
                    this.alltimescorerimagelink = result.data.data[0].image_all_time_scorer;
                    this.alltimeassisterimagelink = result.data.data[0].image_all_time_assister;
                    this.alltimeappearancesimagelink = result.data.data[0].image_all_time_appearances;
                    this.imagebadge = result.data.data[0].image_badge;
                    this.imageheadline = result.data.data[0].image_headline;
                    this.totalwinshome = result.data.data[0].total_wins_home;
                    this.totalwinsaway = result.data.data[0].total_wins_away;
                    this.kickofftime = result.data.data[0].kick_off_time;
                    this.totalwinshomeathome = result.data.data[0].total_wins_home_at_home;
                    this.totalwinshomeataway = result.data.data[0].total_wins_home_at_away;
                    this.totalwinsawayathome = result.data.data[0].total_wins_away_at_home;
                    this.totalwinsawayataway = result.data.data[0].total_wins_away_at_away;
                    this.gamesplayedagainst = result.data.data[0].games_played_against;
                    this.draws = result.data.data[0].draws;
                    this.homekit = result.data.data[0].home_kit;
                    this.awaykit = result.data.data[0].away_kit;
                    this.thirdkit = result.data.data[0].third_kit;
                    this.hometeam = result.data.data[0].home_team;
                    this.awayteam = result.data.data[0].away_team;
                    this.yearmmdd = this.nextgame.substring(0,10)
